...
$entry = file_get_contents(dirname(__DIR__) . '/sr-private-downloads.php');
assert_true($entry !== false, 'plugin entry file is readable');
assert_true(str_contains($entry, 'Plugin Name: Stock Resource Private Downloads'), 'plugin header declares the private downloads plugin name');
...
assert_same('sr-private-downloads', Plugin::slug(), 'plugin exposes stable slug');
...
echo "sr-private-downloads skeleton tests: ok\n";
