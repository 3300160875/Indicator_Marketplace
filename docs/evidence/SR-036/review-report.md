...
- Independent QA: Dalton found idempotent approval replay could bypass lock/bill validation; fix now validates lock version and real bill parameters before replay success.
