...
- Independent QA: Dalton found idempotent approval replay could bypass lock/bill validation; fix now validates replay lock version and bill fingerprint/amount before returning success.
