...
- SR-031 已进入 REVIEW：EDD 3.6.9 订单、订单项、客户与退款 fixture 已封装为 `Integration/Edd` Adapter，完成/退款事件投影到 SR-007 合约 DTO，EDD API 触点未散落到领域层。
...
1. 完成 SR-031 PR / CI / merge / VERIFIED 收口。
